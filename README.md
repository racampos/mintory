...
**🎥 [Watch the 3-minute demo](https://youtu.be/H8JEcfLWAEA)** — See the full pipeline in action from lore generation to NFT mint!
...
**🎬 [See it in action](https://youtu.be/H8JEcfLWAEA)** — Full demo walkthrough from start to finish.

---

## 🎥 Demo Video

[![Mintory Demo - 3 minute walkthrough](https://img.youtube.com/vi/LG9ovU99eD8/maxresdefault.jpg)](https://youtu.be/H8JEcfLWAEA)

**[▶️ Watch the 3-minute demo](https://youtu.be/H8JEcfLWAEA)**
...
> **🎥 Want to see the UX?** [Watch the demo video](https://youtu.be/H8JEcfLWAEA) to experience the full user journey.
